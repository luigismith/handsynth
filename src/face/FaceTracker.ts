 ...
 * Live probe: a user with naturally wide eyes sits at eyeOpen ~0.92 with
 * eyes "normally open" (not widened). Raised to 0.92 so only a clear
 * deliberate "BANG eyes go wide" gesture peg eyesWide. The blendshape
 * eyeBlink saturates near 1 only at maximum stare. */
const EYE_REST = 0.92;
